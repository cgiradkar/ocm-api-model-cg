...
// ClusterManagementReferenceListBuilder contains the data and logic needed to build
// 'cluster_management_reference' objects.
type ClusterManagementReferenceListBuilder struct {
	items []*ClusterManagementReferenceBuilder
}
...
func NewClusterManagementReferenceList() *ClusterManagementReferenceListBuilder {
	return new(ClusterManagementReferenceListBuilder)
}
...
func (b *ClusterManagementReferenceListBuilder) Items(values ...*ClusterManagementReferenceBuilder) *ClusterManagementReferenceListBuilder {
	b.items = make([]*ClusterManagementReferenceBuilder, len(values))
	copy(b.items, values)
	return b
}
...
func (b *ClusterManagementReferenceListBuilder) Copy(list *ClusterManagementReferenceList) *ClusterManagementReferenceListBuilder {
	if list == nil || list.items == nil {
		...
		b.items = make([]*ClusterManagementReferenceBuilder, len(list.items))
		for i, v := range list.items {
			b.items[i] = NewClusterManagementReference().Copy(v)
		}
	}
	return b
}

// Build creates a list of 'cluster_management_reference' objects using the
// configuration stored in the builder.
func (b *ClusterManagementReferenceListBuilder) Build() (list *ClusterManagementReferenceList, err error) {
	items := make([]*ClusterManagementReference, len(b.items))
	...
	list = new(ClusterManagementReferenceList)
	list.items = items
	return
}
