...
func (o *ManagementClusterRequestPayload) GetService_cluster_idService_cluster_idService_cluster_idService_cluster_idId() (value string, ok bool) {
	...
	if ok {
		value = o.service_cluster_idService_cluster_idService_cluster_idService_cluster_idId
	}
	return
}

// ManagementClusterRequestPayloadListKind is the name of the type used to represent list of objects of
// type 'management_cluster_request_payload'.
const ManagementClusterRequestPayloadListKind = "ManagementClusterRequestPayloadList"

// ManagementClusterRequestPayloadListLinkKind is the name of the type used to represent links to list
// of objects of type 'management_cluster_request_payload'.
const ManagementClusterRequestPayloadListLinkKind = "ManagementClusterRequestPayloadListLink"

// ManagementClusterRequestPayloadNilKind is the name of the type used to nil lists of objects of
// type 'management_cluster_request_payload'.
...
type ManagementClusterRequestPayloadList struct {
	href  string
	link  bool
	items []*ManagementClusterRequestPayload
}
...
func (l *ManagementClusterRequestPayloadList) Slice() []*ManagementClusterRequestPayload {
	...
	if l == nil {
		slice = make([]*ManagementClusterRequestPayload, 0)
	} else {
		slice = make([]*ManagementClusterRequestPayload, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
