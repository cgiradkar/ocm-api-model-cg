...
// LabelRequestPayloadListKind is the name of the type used to represent list of objects of
// type 'label_request_payload'.
const LabelRequestPayloadListKind = "LabelRequestPayloadList"

// LabelRequestPayloadListLinkKind is the name of the type used to represent links to list
// of objects of type 'label_request_payload'.
const LabelRequestPayloadListLinkKind = "LabelRequestPayloadListLink"

// LabelRequestPayloadNilKind is the name of the type used to nil lists of objects of
// type 'label_request_payload'.
...
func (l *LabelRequestPayloadList) Slice() []*LabelRequestPayload {
	var slice []*LabelRequestPayload
	if l == nil {
		slice = make([]*LabelRequestPayload, 0)
	} else {
		slice = make([]*LabelRequestPayload, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
