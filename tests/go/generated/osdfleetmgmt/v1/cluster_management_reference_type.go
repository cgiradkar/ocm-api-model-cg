...
// ClusterManagementReferenceListKind is the name of the type used to represent list of objects of
// type 'cluster_management_reference'.
const ClusterManagementReferenceListKind = "ClusterManagementReferenceList"

// ClusterManagementReferenceListLinkKind is the name of the type used to represent links to list
// of objects of type 'cluster_management_reference'.
const ClusterManagementReferenceListLinkKind = "ClusterManagementReferenceListLink"

// ClusterManagementReferenceNilKind is the name of the type used to nil lists of objects of
// type 'cluster_management_reference'.
...
type ClusterManagementReferenceList struct {
	href  string
	link  bool
	items []*ClusterManagementReference
}
...
func (l *ClusterManagementReferenceList) Slice() []*ClusterManagementReference {
	var slice []*ClusterManagementReference
	if l == nil {
		slice = make([]*ClusterManagementReference, 0)
	} else {
		slice = make([]*ClusterManagementReference, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
