...
func writeManagementClusterRequestPayload(object *ManagementClusterRequestPayload, stream *jsoniter.Stream) {
	...
	if present_ {
		...
		stream.WriteObjectField("service_cluster_id_service_cluster_id_service_cluster_id_service_cluster_id_id")
		stream.WriteString(object.service_cluster_idService_cluster_idService_cluster_idService_cluster_idId)
	}
	stream.WriteObjectEnd()
}

// UnmarshalManagementClusterRequestPayload reads a value of the 'management_cluster_request_payload' type from the given
