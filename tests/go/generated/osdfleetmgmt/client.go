...
package osdfleetmgmt // github.com/openshift-online/ocm-api-metamodel/tests/go/generated/osdfleetmgmt
...
// Client is the client for service 'osd_fleet_mgmt'.
type Client struct {
	transport http.RoundTripper
	path      string
}

// NewClient creates a new client for the service 'osd_fleet_mgmt' using the
