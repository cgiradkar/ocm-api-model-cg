...
package jobqueue // github.com/openshift-online/ocm-api-metamodel/tests/go/generated/jobqueue
...
// NewClient creates a new client for the service 'job_queue' using the
