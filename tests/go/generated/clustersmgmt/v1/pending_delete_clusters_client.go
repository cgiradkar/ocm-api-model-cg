...
// NewPendingDeleteClustersClient creates a new client for the 'pending_delete_clusters'
// resource using the given transport to send the requests and receive the
// responses.
func NewPendingDeleteClustersClient(transport http.RoundTripper, path string) *PendingDeleteClustersClient {
	return &PendingDeleteClustersClient{
		transport: transport,
		path:      path,
	}
}
...
func (c *PendingDeleteClustersClient) List() *PendingDeleteClustersListRequest {
	return &PendingDeleteClustersListRequest{
...
func (c *PendingDeleteClustersClient) PendingDeleteCluster(id string) *PendingDeleteClusterClient {
	return NewPendingDeleteClusterClient(
		c.transport,
		path.Join(c.path, id),
	)
}
...
func (r *PendingDeleteClustersListRequest) Impersonate(user string) *PendingDeleteClustersListRequest {
...
func (r *PendingDeleteClustersListRequest) Order(value string) *PendingDeleteClustersListRequest {
	r.order = &value
	return r
}
...
func (r *PendingDeleteClustersListRequest) Page(value int) *PendingDeleteClustersListRequest {
	r.page = &value
	return r
}
...
func (r *PendingDeleteClustersListRequest) Search(value string) *PendingDeleteClustersListRequest {
	r.search = &value
	return r
}
...
func (r *PendingDeleteClustersListRequest) Size(value int) *PendingDeleteClustersListRequest {
	r.size = &value
	return r
}
...
func (r *PendingDeleteClustersListRequest) Send() (result *PendingDeleteClustersListResponse, err error) {
	return r.SendContext(context.Background())
}

// SendContext sends this request, waits for the response, and returns it.
func (r *PendingDeleteClustersListRequest) SendContext(ctx context.Context) (result *PendingDeleteClustersListResponse, err error) {
	...
	result = &PendingDeleteClustersListResponse{}
	...
	err = readPendingDeleteClustersListResponse(result, reader)
	if err != nil {
		return
	}
	return
...
type PendingDeleteClustersListResponse struct {
	...
	header http.Header
	err    *errors.Error
	items  *PendingDeleteClusterList
	page   *int
	size   *int
	total  *int
}
...
func (r *PendingDeleteClustersListResponse) Status() int {
	if r == nil {
		return 0
	}
	return r.status
...
func (r *PendingDeleteClustersListResponse) Header() http.Header {
	if r == nil {
		return nil
	}
	return r.header
...
func (r *PendingDeleteClustersListResponse) Error() *errors.Error {
	if r == nil {
		return nil
	}
	return r.err
...
func (r *PendingDeleteClustersListResponse) Items() *PendingDeleteClusterList {
	if r == nil {
		return nil
	}
	return r.items
...
//
// Retrieved list of pending delete clusters.
func (r *PendingDeleteClustersListResponse) GetItems() (value *PendingDeleteClusterList, ok bool) {
...
//
// Index of the requested page, where one corresponds to the first page.
func (r *PendingDeleteClustersListResponse) Page() int {
	if r != nil && r.page != nil {
		return *r.page
	}
	return 0
...
//
// Maximum number of items that will be contained in the returned page.
func (r *PendingDeleteClustersListResponse) Size() int {
	if r != nil && r.size != nil {
		return *r.size
	}
	return 0
...
func (r *PendingDeleteClustersListResponse) Total() int {
