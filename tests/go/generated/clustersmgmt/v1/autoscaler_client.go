...
func (c *AutoscalerClient) Delete() *AutoscalerDeleteRequest {
	return &AutoscalerDeleteRequest{
...
func (c *AutoscalerClient) Post() *AutoscalerPostRequest {
	return &AutoscalerPostRequest{
		transport: c.transport,
		path:      c.path,
	}
}
...
func (r *AutoscalerDeleteRequest) Impersonate(user string) *AutoscalerDeleteRequest {
...
func (r *AutoscalerDeleteRequest) SendContext(ctx context.Context) (result *AutoscalerDeleteResponse, err error) {
	...
	result = &AutoscalerDeleteResponse{}
...
// Error returns the response error.
func (r *AutoscalerDeleteResponse) Error() *errors.Error {
	if r == nil {
		return nil
	}
	return r.err
...
func (r *AutoscalerPostRequest) SendContext(ctx context.Context) (result *AutoscalerPostResponse, err error) {
	...
	header := helpers.CopyHeader(r.header)
	buffer := &bytes.Buffer{}
	err = writeAutoscalerPostRequest(r, buffer)
	if err != nil {
		return
	}
	uri := &url.URL{
	...
	err = readAutoscalerPostResponse(result, reader)
	if err != nil {
		return
	}
	return
