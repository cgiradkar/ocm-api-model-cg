...
// NewProductMinimalVersionsClient creates a new client for the 'product_minimal_versions'
// resource using the given transport to send the requests and receive the
// responses.
func NewProductMinimalVersionsClient(transport http.RoundTripper, path string) *ProductMinimalVersionsClient {
	return &ProductMinimalVersionsClient{
		transport: transport,
		path:      path,
	}
}
...
func (c *ProductMinimalVersionsClient) List() *ProductMinimalVersionsListRequest {
	return &ProductMinimalVersionsListRequest{
...
func (c *ProductMinimalVersionsClient) MinimalVersion(id string) *ProductMinimalVersionClient {
...
func (r *ProductMinimalVersionsListRequest) Header(name string, value interface{}) *ProductMinimalVersionsListRequest {
...
func (r *ProductMinimalVersionsListRequest) Impersonate(user string) *ProductMinimalVersionsListRequest {
...
func (r *ProductMinimalVersionsListRequest) Order(value string) *ProductMinimalVersionsListRequest {
	r.order = &value
	return r
}
...
func (r *ProductMinimalVersionsListRequest) Page(value int) *ProductMinimalVersionsListRequest {
	r.page = &value
	return r
}
...
func (r *ProductMinimalVersionsListRequest) Search(value string) *ProductMinimalVersionsListRequest {
	r.search = &value
	return r
}
...
func (r *ProductMinimalVersionsListRequest) Size(value int) *ProductMinimalVersionsListRequest {
	r.size = &value
	return r
}
...
func (r *ProductMinimalVersionsListRequest) Send() (result *ProductMinimalVersionsListResponse, err error) {
	return r.SendContext(context.Background())
}

// SendContext sends this request, waits for the response, and returns it.
func (r *ProductMinimalVersionsListRequest) SendContext(ctx context.Context) (result *ProductMinimalVersionsListResponse, err error) {
	...
	result = &ProductMinimalVersionsListResponse{}
	...
	err = readProductMinimalVersionsListResponse(result, reader)
	if err != nil {
		return
	}
	return
...
type ProductMinimalVersionsListResponse struct {
	...
	header http.Header
	err    *errors.Error
	items  *ProductMinimalVersionList
	page   *int
	size   *int
	total  *int
}
...
func (r *ProductMinimalVersionsListResponse) Status() int {
	if r == nil {
		return 0
	}
	return r.status
...
func (r *ProductMinimalVersionsListResponse) Header() http.Header {
	if r == nil {
		return nil
	}
	return r.header
...
func (r *ProductMinimalVersionsListResponse) Error() *errors.Error {
	if r == nil {
		return nil
	}
	return r.err
...
func (r *ProductMinimalVersionsListResponse) Items() *ProductMinimalVersionList {
	if r == nil {
		return nil
	}
	return r.items
...
//
// Retrieved list of product minimal versions.
func (r *ProductMinimalVersionsListResponse) GetItems() (value *ProductMinimalVersionList, ok bool) {
...
//
// Index of the requested page, where one corresponds to the first page.
func (r *ProductMinimalVersionsListResponse) Page() int {
	if r != nil && r.page != nil {
		return *r.page
	}
	return 0
...
//
// Maximum number of items that will be contained in the returned page.
func (r *ProductMinimalVersionsListResponse) Size() int {
	if r != nil && r.size != nil {
		return *r.size
	}
	return 0
...
func (r *ProductMinimalVersionsListResponse) Total() int {
