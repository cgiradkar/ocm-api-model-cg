...
// AddOnInstallationParameterListBuilder contains the data and logic needed to build
// 'add_on_installation_parameter' objects.
...
func NewAddOnInstallationParameterList() *AddOnInstallationParameterListBuilder {
	return new(AddOnInstallationParameterListBuilder)
}
...
func (b *AddOnInstallationParameterListBuilder) Copy(list *AddOnInstallationParameterList) *AddOnInstallationParameterListBuilder {
	if list == nil || list.items == nil {
		...
		b.items = make([]*AddOnInstallationParameterBuilder, len(list.items))
...
// Build creates a list of 'add_on_installation_parameter' objects using the
// configuration stored in the builder.
func (b *AddOnInstallationParameterListBuilder) Build() (list *AddOnInstallationParameterList, err error) {
	items := make([]*AddOnInstallationParameter, len(b.items))
	...
	list = new(AddOnInstallationParameterList)
	list.items = items
	return
}
