...
// MarshalOrganizationLinkList writes a list of values of the 'organization_link' type to
// the given writer.
...
// UnmarshalOrganizationLinkList reads a list of values of the 'organization_link' type
