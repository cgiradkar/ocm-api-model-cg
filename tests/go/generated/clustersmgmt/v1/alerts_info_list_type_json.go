...
// MarshalAlertsInfoList writes a list of values of the 'alerts_info' type to
// the given writer.
...
// writeAlertsInfoList writes a list of value of the 'alerts_info' type to
// the given stream.
func writeAlertsInfoList(list []*AlertsInfo, stream *jsoniter.Stream) {
...
// UnmarshalAlertsInfoList reads a list of values of the 'alerts_info' type
...
func UnmarshalAlertsInfoList(source interface{}) (items []*AlertsInfo, err error) {
	...
	items = readAlertsInfoList(iterator)
	err = iterator.Error
	return
}
