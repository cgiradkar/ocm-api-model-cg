...
func writeCluster(object *Cluster, stream *jsoniter.Stream) {
	...
	present_ = object.bitmap_&65536 != 0 && object.byoOidc != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&131072 != 0 && object.cloudProvider != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&262144 != 0 && object.console != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&1048576 != 0 && object.deleteProtection != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&67108864 != 0 && object.externalAuthConfig != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&134217728 != 0 && object.externalConfiguration != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&268435456 != 0 && object.flavour != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&536870912 != 0 && object.groups != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&2147483648 != 0 && object.htpasswd != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&4294967296 != 0 && object.hypershift != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&8589934592 != 0 && object.identityProviders != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&17179869184 != 0 && object.inflightChecks != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&68719476736 != 0 && object.ingresses != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&137438953472 != 0 && object.kubeletConfig != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&549755813888 != 0 && object.machinePools != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&2199023255552 != 0 && object.managedService != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&17592186044416 != 0 && object.network != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&35184372088832 != 0 && object.nodeDrainGracePeriod != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&70368744177664 != 0 && object.nodePools != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&140737488355328 != 0 && object.nodes != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&281474976710656 != 0
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&562949953421312 != 0 && object.product != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&1125899906842624 != 0 && object.properties != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&2251799813685248 != 0 && object.provisionShard != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&4503599627370496 != 0 && object.proxy != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&9007199254740992 != 0 && object.region != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&18014398509481984 != 0
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&36028797018963968 != 0 && object.status != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&72057594037927936 != 0 && object.storageQuota != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&144115188075855872 != 0 && object.subscription != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&288230376151711744 != 0 && object.version != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
