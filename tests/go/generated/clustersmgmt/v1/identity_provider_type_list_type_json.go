...
// MarshalIdentityProviderTypeList writes a list of values of the 'identity_provider_type' type to
// the given writer.
...
// writeIdentityProviderTypeList writes a list of value of the 'identity_provider_type' type to
// the given stream.
func writeIdentityProviderTypeList(list []IdentityProviderType, stream *jsoniter.Stream) {
...
// UnmarshalIdentityProviderTypeList reads a list of values of the 'identity_provider_type' type
...
func UnmarshalIdentityProviderTypeList(source interface{}) (items []IdentityProviderType, err error) {
	...
	items = readIdentityProviderTypeList(iterator)
	err = iterator.Error
	return
}
...
func readIdentityProviderTypeList(iterator *jsoniter.Iterator) []IdentityProviderType {
	...
	for iterator.ReadArray() {
		...
		item := IdentityProviderType(text)
