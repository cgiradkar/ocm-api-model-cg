...
type SocketTotalsNodeRoleOSMetricNodeListBuilder struct {
	items []*SocketTotalsNodeRoleOSMetricNodeBuilder
}
...
func NewSocketTotalsNodeRoleOSMetricNodeList() *SocketTotalsNodeRoleOSMetricNodeListBuilder {
	return new(SocketTotalsNodeRoleOSMetricNodeListBuilder)
}
...
func (b *SocketTotalsNodeRoleOSMetricNodeListBuilder) Items(values ...*SocketTotalsNodeRoleOSMetricNodeBuilder) *SocketTotalsNodeRoleOSMetricNodeListBuilder {
	b.items = make([]*SocketTotalsNodeRoleOSMetricNodeBuilder, len(values))
	copy(b.items, values)
	return b
}

// Empty returns true if the list is empty.
func (b *SocketTotalsNodeRoleOSMetricNodeListBuilder) Empty() bool {
...
func (b *SocketTotalsNodeRoleOSMetricNodeListBuilder) Copy(list *SocketTotalsNodeRoleOSMetricNodeList) *SocketTotalsNodeRoleOSMetricNodeListBuilder {
	if list == nil || list.items == nil {
		...
		b.items = make([]*SocketTotalsNodeRoleOSMetricNodeBuilder, len(list.items))
		for i, v := range list.items {
			b.items[i] = NewSocketTotalsNodeRoleOSMetricNode().Copy(v)
		}
	}
	return b
}

// Build creates a list of 'socket_totals_node_role_OS_metric_node' objects using the
// configuration stored in the builder.
func (b *SocketTotalsNodeRoleOSMetricNodeListBuilder) Build() (list *SocketTotalsNodeRoleOSMetricNodeList, err error) {
	items := make([]*SocketTotalsNodeRoleOSMetricNode, len(b.items))
	...
	list = new(SocketTotalsNodeRoleOSMetricNodeList)
	list.items = items
	return
}
