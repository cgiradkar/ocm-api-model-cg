...
func writeNodePool(object *NodePool, stream *jsoniter.Stream) {
	...
	present_ = object.bitmap_&256 != 0 && object.nodeDrainGracePeriod != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&8192 != 0 && object.tuningConfigs != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&16384 != 0 && object.version != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
