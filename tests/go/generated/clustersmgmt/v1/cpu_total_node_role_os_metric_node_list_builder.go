...
// CPUTotalNodeRoleOSMetricNodeListBuilder contains the data and logic needed to build
// 'CPU_total_node_role_OS_metric_node' objects.
type CPUTotalNodeRoleOSMetricNodeListBuilder struct {
	items []*CPUTotalNodeRoleOSMetricNodeBuilder
}
...
func NewCPUTotalNodeRoleOSMetricNodeList() *CPUTotalNodeRoleOSMetricNodeListBuilder {
	return new(CPUTotalNodeRoleOSMetricNodeListBuilder)
}
...
func (b *CPUTotalNodeRoleOSMetricNodeListBuilder) Items(values ...*CPUTotalNodeRoleOSMetricNodeBuilder) *CPUTotalNodeRoleOSMetricNodeListBuilder {
	b.items = make([]*CPUTotalNodeRoleOSMetricNodeBuilder, len(values))
	copy(b.items, values)
	return b
}
...
func (b *CPUTotalNodeRoleOSMetricNodeListBuilder) Build() (list *CPUTotalNodeRoleOSMetricNodeList, err error) {
	items := make([]*CPUTotalNodeRoleOSMetricNode, len(b.items))
	...
	list = new(CPUTotalNodeRoleOSMetricNodeList)
	list.items = items
	return
}
