...
// NewAvailableRegionsInquiryClient creates a new client for the 'available_regions_inquiry'
...
func NewAvailableRegionsInquiryClient(transport http.RoundTripper, path string) *AvailableRegionsInquiryClient {
	return &AvailableRegionsInquiryClient{
		transport: transport,
		path:      path,
	}
}
...
// of the provider.
func (c *AvailableRegionsInquiryClient) Search() *AvailableRegionsInquirySearchRequest {
	return &AvailableRegionsInquirySearchRequest{
...
func (r *AvailableRegionsInquirySearchRequest) Parameter(name string, value interface{}) *AvailableRegionsInquirySearchRequest {
	helpers.AddValue(&r.query, name, value)
	return r
}

// Header adds a request header.
func (r *AvailableRegionsInquirySearchRequest) Header(name string, value interface{}) *AvailableRegionsInquirySearchRequest {
...
func (r *AvailableRegionsInquirySearchRequest) Body(value *CloudProviderData) *AvailableRegionsInquirySearchRequest {
	r.body = value
	return r
}
...
func (r *AvailableRegionsInquirySearchRequest) Page(value int) *AvailableRegionsInquirySearchRequest {
	r.page = &value
	return r
}
...
func (r *AvailableRegionsInquirySearchRequest) Size(value int) *AvailableRegionsInquirySearchRequest {
	r.size = &value
	return r
}
...
func (r *AvailableRegionsInquirySearchRequest) SendContext(ctx context.Context) (result *AvailableRegionsInquirySearchResponse, err error) {
	...
	buffer := &bytes.Buffer{}
	err = writeAvailableRegionsInquirySearchRequest(r, buffer)
	if err != nil {
		return
	}
	uri := &url.URL{
...
func (r *AvailableRegionsInquirySearchResponse) Status() int {
	if r == nil {
		return 0
	}
	return r.status
...
func (r *AvailableRegionsInquirySearchResponse) Header() http.Header {
	if r == nil {
		return nil
	}
	return r.header
...
func (r *AvailableRegionsInquirySearchResponse) Error() *errors.Error {
	if r == nil {
		return nil
	}
	return r.err
...
func (r *AvailableRegionsInquirySearchResponse) Items() *CloudRegionList {
	if r == nil {
		return nil
	}
	return r.items
...
// Index of the returned page, where one corresponds to the first page. As this
// collection doesn't support paging the result will always be `1`.
func (r *AvailableRegionsInquirySearchResponse) Page() int {
	if r != nil && r.page != nil {
		return *r.page
	}
	return 0
...
// doesn't support paging or searching the result will always be the total number of
// regions of the provider.
func (r *AvailableRegionsInquirySearchResponse) Size() int {
	if r != nil && r.size != nil {
		return *r.size
	}
	return 0
...
func (r *AvailableRegionsInquirySearchResponse) Total() int {
