...
// MarshalSupportCaseResponseList writes a list of values of the 'support_case_response' type to
// the given writer.
...
// UnmarshalSupportCaseResponseList reads a list of values of the 'support_case_response' type
