...
// MarshalRegistryCredentialList writes a list of values of the 'registry_credential' type to
// the given writer.
...
// UnmarshalRegistryCredentialList reads a list of values of the 'registry_credential' type
