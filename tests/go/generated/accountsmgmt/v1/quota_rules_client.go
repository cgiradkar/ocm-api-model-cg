...
// to retrieve the quota rule for all add-ons:
//
// ```sql
...
func (r *QuotaRulesListRequest) SendContext(ctx context.Context) (result *QuotaRulesListResponse, err error) {
	...
	err = readQuotaRulesListResponse(result, reader)
	if err != nil {
		return
	}
	return
