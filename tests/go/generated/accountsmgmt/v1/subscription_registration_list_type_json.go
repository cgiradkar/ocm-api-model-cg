...
// MarshalSubscriptionRegistrationList writes a list of values of the 'subscription_registration' type to
// the given writer.
...
// UnmarshalSubscriptionRegistrationList reads a list of values of the 'subscription_registration' type
