...
package statusboard // github.com/openshift-online/ocm-api-metamodel/tests/go/generated/statusboard
...
// Client is the client for service 'status_board'.
type Client struct {
	transport http.RoundTripper
	path      string
}

// NewClient creates a new client for the service 'status_board' using the
