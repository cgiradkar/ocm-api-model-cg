...
// AddonInstallationParametersListKind is the name of the type used to represent list of objects of
// type 'addon_installation_parameters'.
const AddonInstallationParametersListKind = "AddonInstallationParametersList"

// AddonInstallationParametersListLinkKind is the name of the type used to represent links to list
// of objects of type 'addon_installation_parameters'.
const AddonInstallationParametersListLinkKind = "AddonInstallationParametersListLink"

// AddonInstallationParametersNilKind is the name of the type used to nil lists of objects of
// type 'addon_installation_parameters'.
...
type AddonInstallationParametersList struct {
	href  string
	link  bool
	items []*AddonInstallationParameters
}
...
func (l *AddonInstallationParametersList) Slice() []*AddonInstallationParameters {
	var slice []*AddonInstallationParameters
	if l == nil {
		slice = make([]*AddonInstallationParameters, 0)
	} else {
		slice = make([]*AddonInstallationParameters, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
