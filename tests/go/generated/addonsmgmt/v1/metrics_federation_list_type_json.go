...
// MarshalMetricsFederationList writes a list of values of the 'metrics_federation' type to
// the given writer.
...
// UnmarshalMetricsFederationList reads a list of values of the 'metrics_federation' type
