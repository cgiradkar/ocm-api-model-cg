...
// AddonParametersListKind is the name of the type used to represent list of objects of
// type 'addon_parameters'.
const AddonParametersListKind = "AddonParametersList"

// AddonParametersListLinkKind is the name of the type used to represent links to list
// of objects of type 'addon_parameters'.
const AddonParametersListLinkKind = "AddonParametersListLink"

// AddonParametersNilKind is the name of the type used to nil lists of objects of
// type 'addon_parameters'.
...
func (l *AddonParametersList) Slice() []*AddonParameters {
	var slice []*AddonParameters
	if l == nil {
		slice = make([]*AddonParameters, 0)
	} else {
		slice = make([]*AddonParameters, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
