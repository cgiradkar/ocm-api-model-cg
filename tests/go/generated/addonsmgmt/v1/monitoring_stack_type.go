...
// MonitoringStackListKind is the name of the type used to represent list of objects of
// type 'monitoring_stack'.
const MonitoringStackListKind = "MonitoringStackList"

// MonitoringStackListLinkKind is the name of the type used to represent links to list
// of objects of type 'monitoring_stack'.
const MonitoringStackListLinkKind = "MonitoringStackListLink"

// MonitoringStackNilKind is the name of the type used to nil lists of objects of
// type 'monitoring_stack'.
...
func (l *MonitoringStackList) Slice() []*MonitoringStack {
	var slice []*MonitoringStack
	if l == nil {
		slice = make([]*MonitoringStack, 0)
	} else {
		slice = make([]*MonitoringStack, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
