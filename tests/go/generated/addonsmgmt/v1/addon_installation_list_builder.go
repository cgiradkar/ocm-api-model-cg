...
// AddonInstallationListBuilder contains the data and logic needed to build
// 'addon_installation' objects.
type AddonInstallationListBuilder struct {
	items []*AddonInstallationBuilder
}
...
// Build creates a list of 'addon_installation' objects using the
// configuration stored in the builder.
func (b *AddonInstallationListBuilder) Build() (list *AddonInstallationList, err error) {
	items := make([]*AddonInstallation, len(b.items))
