...
// MarshalAddonRequirementStatusList writes a list of values of the 'addon_requirement_status' type to
// the given writer.
...
// UnmarshalAddonRequirementStatusList reads a list of values of the 'addon_requirement_status' type
