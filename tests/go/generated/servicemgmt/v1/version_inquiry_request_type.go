...
// VersionInquiryRequestListKind is the name of the type used to represent list of objects of
// type 'version_inquiry_request'.
const VersionInquiryRequestListKind = "VersionInquiryRequestList"

// VersionInquiryRequestListLinkKind is the name of the type used to represent links to list
// of objects of type 'version_inquiry_request'.
const VersionInquiryRequestListLinkKind = "VersionInquiryRequestListLink"

// VersionInquiryRequestNilKind is the name of the type used to nil lists of objects of
// type 'version_inquiry_request'.
...
func (l *VersionInquiryRequestList) Slice() []*VersionInquiryRequest {
	var slice []*VersionInquiryRequest
	if l == nil {
		slice = make([]*VersionInquiryRequest, 0)
	} else {
		slice = make([]*VersionInquiryRequest, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
