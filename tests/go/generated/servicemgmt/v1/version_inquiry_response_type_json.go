...
func MarshalVersionInquiryResponse(object *VersionInquiryResponse, writer io.Writer) error {
	...
	writeVersionInquiryResponse(object, stream)
	err := stream.Flush()
	if err != nil {
		return err
	}
...
// UnmarshalVersionInquiryResponse reads a value of the 'version_inquiry_response' type from the given
...
func UnmarshalVersionInquiryResponse(source interface{}) (object *VersionInquiryResponse, err error) {
	...
	object = readVersionInquiryResponse(iterator)
	err = iterator.Error
	return
}
