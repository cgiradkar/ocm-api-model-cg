...
// VersionInquiryResponseListKind is the name of the type used to represent list of objects of
// type 'version_inquiry_response'.
const VersionInquiryResponseListKind = "VersionInquiryResponseList"

// VersionInquiryResponseListLinkKind is the name of the type used to represent links to list
// of objects of type 'version_inquiry_response'.
const VersionInquiryResponseListLinkKind = "VersionInquiryResponseListLink"

// VersionInquiryResponseNilKind is the name of the type used to nil lists of objects of
// type 'version_inquiry_response'.
...
func (l *VersionInquiryResponseList) Slice() []*VersionInquiryResponse {
	var slice []*VersionInquiryResponse
	if l == nil {
		slice = make([]*VersionInquiryResponse, 0)
	} else {
		slice = make([]*VersionInquiryResponse, len(l.items))
		copy(slice, l.items)
	}
	return slice
}
