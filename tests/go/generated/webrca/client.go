...
package webrca // github.com/openshift-online/ocm-api-metamodel/tests/go/generated/webrca
...
// NewClient creates a new client for the service 'web_rca' using the
