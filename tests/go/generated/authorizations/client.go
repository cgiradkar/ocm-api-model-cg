...
package authorizations // github.com/openshift-online/ocm-api-metamodel/tests/go/generated/authorizations
...
// NewClient creates a new client for the service 'authorizations' using the
