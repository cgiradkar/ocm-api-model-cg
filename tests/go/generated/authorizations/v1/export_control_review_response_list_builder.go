...
// ExportControlReviewResponseListBuilder contains the data and logic needed to build
// 'export_control_review_response' objects.
type ExportControlReviewResponseListBuilder struct {
	items []*ExportControlReviewResponseBuilder
}
...
func NewExportControlReviewResponseList() *ExportControlReviewResponseListBuilder {
	return new(ExportControlReviewResponseListBuilder)
}
...
func (b *ExportControlReviewResponseListBuilder) Items(values ...*ExportControlReviewResponseBuilder) *ExportControlReviewResponseListBuilder {
	b.items = make([]*ExportControlReviewResponseBuilder, len(values))
	copy(b.items, values)
	return b
}
...
func (b *ExportControlReviewResponseListBuilder) Copy(list *ExportControlReviewResponseList) *ExportControlReviewResponseListBuilder {
	if list == nil || list.items == nil {
		...
		b.items = make([]*ExportControlReviewResponseBuilder, len(list.items))
		for i, v := range list.items {
			b.items[i] = NewExportControlReviewResponse().Copy(v)
		}
	}
	return b
}

// Build creates a list of 'export_control_review_response' objects using the
// configuration stored in the builder.
func (b *ExportControlReviewResponseListBuilder) Build() (list *ExportControlReviewResponseList, err error) {
	items := make([]*ExportControlReviewResponse, len(b.items))
